...
import type { DiskData } from '../../../models/monitor.model';

interface ServerDiskViewProps {
    serverIp: string;
}

// Rutas críticas para el filtro rápido
...
const ServerDiskView: React.FC<ServerDiskViewProps> = ({ serverIp }) => {
    ...
    const exportToPDF = () => {
        ...
        autoTable(doc, {
            ...
            body: pdfData,
            styles: { fontSize: 8 },
            headStyles: { fillColor: [63, 66, 241], fontStyle: 'bold' },
                        ...
                        <div className={styles.filterWrapper} ref={filterRef}>
                            ...
                            {isFilterOpen && (
                                <div className={styles.filterMenu}>
                                    ...
                                    <div className={styles.filterQuickActions} style={{ padding: '8px 12px', borderBottom: '1px solid #e2e8f0', display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                                        <button onClick={hideSnaps} className={styles.presetBtn} style={{ fontSize: '0.75rem', padding: '4px 8px', background: '#e0e7ff', color: '#4338ca', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
                                            No Snaps
                                        </button>
                                        <button onClick={showBackupsOnly} className={styles.presetBtn} style={{ fontSize: '0.75rem', padding: '4px 8px', background: '#fef3c7', color: '#b45309', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
                                            Solo Backups
                                        </button>
                                    </div>
